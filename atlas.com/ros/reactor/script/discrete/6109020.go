...
func New6109020() script.Script {
	return generic.NewReactor(6109020, generic.SetAct(func(l logrus.FieldLogger, span opentracing.Span, db *gorm.DB, c script.Context) {
