...
func NewTransparent2() script.Script {
	return generic.NewReactor(reactor.Transparent2, generic.SetAct(Transparent2Act))
}

func Transparent2Act(l logrus.FieldLogger, db *gorm.DB, c script.Context) {
