...
func New9108005() script.Script {
	return generic.NewReactor(9108005, generic.SetAct(func(l logrus.FieldLogger, span opentracing.Span, db *gorm.DB, c script.Context) {
