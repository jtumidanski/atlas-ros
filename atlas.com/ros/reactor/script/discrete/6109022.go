...
func New6109022() script.Script {
	return generic.NewReactor(6109022, generic.SetAct(generic.NoOp), generic.SetTouch(Touch6109022()), generic.SetRelease(Release6109022()))
}

func Touch6109022() script.TouchFunc {
...
func Action6109022(l logrus.FieldLogger, c script.Context) {
...
func Release6109022() script.ReleaseFunc {
	return func(l logrus.FieldLogger, db *gorm.DB, c script.Context) {
		fid := "glpq_f2"
		if !event.ParticipatingInEvent(l)(c.CharacterId) {
			return
