...
func New6109009() script.Script {
	return generic.NewReactor(6109009, generic.SetAct(func(l logrus.FieldLogger, span opentracing.Span, db *gorm.DB, c script.Context) {
