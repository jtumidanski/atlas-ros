...
func New9108004() script.Script {
	return generic.NewReactor(9108004, generic.SetAct(func(l logrus.FieldLogger, span opentracing.Span, db *gorm.DB, c script.Context) {
