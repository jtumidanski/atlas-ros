...
func NewTransparent13() script.Script {
	return generic.NewReactor(reactor.Transparent13, generic.SetAct(Transparent13Act))
}

func Transparent13Act(l logrus.FieldLogger, db *gorm.DB, c script.Context) {
