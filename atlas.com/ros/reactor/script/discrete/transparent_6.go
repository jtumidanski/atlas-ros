...
func NewTransparent6() script.Script {
	return generic.NewReactor(reactor.Transparent6, generic.SetAct(Transparent6Act))
}

func Transparent6Act(l logrus.FieldLogger, db *gorm.DB, c script.Context) {
