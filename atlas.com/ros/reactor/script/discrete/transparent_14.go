...
func NewTransparent14() script.Script {
	return generic.NewReactor(reactor.Transparent14, generic.SetAct(Transparent14Act))
}

func Transparent14Act(l logrus.FieldLogger, db *gorm.DB, c script.Context) {
