...
func NewTransparent12() script.Script {
	return generic.NewReactor(reactor.Transparent12, generic.SetAct(Transparent12Act))
}

func Transparent12Act(l logrus.FieldLogger, db *gorm.DB, c script.Context) {
