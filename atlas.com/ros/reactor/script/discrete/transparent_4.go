...
func NewTransparent4() script.Script {
	return generic.NewReactor(reactor.Transparent4, generic.SetAct(Transparent4Act))
}

func Transparent4Act(l logrus.FieldLogger, db *gorm.DB, c script.Context) {
