...
func NewTransparent8() script.Script {
	return generic.NewReactor(reactor.Transparent8, generic.SetAct(Transparent8Act))
}

func Transparent8Act(l logrus.FieldLogger, db *gorm.DB, c script.Context) {
