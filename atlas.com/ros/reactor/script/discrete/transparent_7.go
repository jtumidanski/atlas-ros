...
func NewTransparent7() script.Script {
	return generic.NewReactor(reactor.Transparent7, generic.SetAct(Transparent7Act))
}

func Transparent7Act(l logrus.FieldLogger, db *gorm.DB, c script.Context) {
