...
func New6109016() script.Script {
	return generic.NewReactor(6109016, generic.SetAct(func(l logrus.FieldLogger, span opentracing.Span, db *gorm.DB, c script.Context) {
