...
func NewTransparent3() script.Script {
	return generic.NewReactor(reactor.Transparent3, generic.SetAct(Transparent3Act))
}

func Transparent3Act(l logrus.FieldLogger, db *gorm.DB, c script.Context) {
