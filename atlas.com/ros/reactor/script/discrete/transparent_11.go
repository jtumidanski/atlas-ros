...
func NewTransparent11() script.Script {
	return generic.NewReactor(reactor.Transparent11, generic.SetAct(Transparent11Act))
}

func Transparent11Act(l logrus.FieldLogger, c script.Context) {
