...
func NewTransparent5() script.Script {
	return generic.NewReactor(reactor.Transparent5, generic.SetAct(Transparent5Act))
}

func Transparent5Act(l logrus.FieldLogger, db *gorm.DB, c script.Context) {
